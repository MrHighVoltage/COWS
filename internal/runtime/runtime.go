...
// NetworkRuntime is an optional runtime capability for server-selected,
// per-workspace private networks. Network names are generated by COWS and are
// never accepted from a browser.
type NetworkRuntime interface {
	CreateWorkspaceNetwork(ctx context.Context, name string) error
	RemoveWorkspaceNetwork(ctx context.Context, name string) error
}
